...
namespace OneImlx.Terminal.Hosting
{
    public class RunMethodBuilderTests
    {
        ...
        public void Build_Adds_RunMethod_To_CommandBuilder_ServiceCollection()
        {
            ...
            ICommandBuilder commandBuilder = terminalBuilder.DefineCommand<MockCommandRunner>("cmd1", "name1", "Command description", CommandType.Leaf, CommandFlags.None).Checker<MockCommandChecker>();
