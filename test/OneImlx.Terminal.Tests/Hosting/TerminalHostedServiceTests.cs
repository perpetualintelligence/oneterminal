        ...
        public async Task StartAsync_ShouldNotRegister_HelpArgument_IfDisabled()
        {
            ...
            .ConfigureServices(services =>
            {
                services.AddTerminalConsole<TerminalInMemoryCommandStore>(new TerminalTextHandler(StringComparison.OrdinalIgnoreCase, Encoding.Unicode), options => { })
                    .DefineCommand<MockCommandRunner>("cmd1", "cmd1", "test1", CommandTypes.Leaf)
                        .DefineOption("id1", nameof(Int32), "test opt1", BehaviorFlags.None, "alias_id1").Add()
                    .Checker<MockCommandChecker>()
                    .Add()
                    .DefineCommand<MockCommandRunner>("cmd2", "cmd2", "test2", CommandTypes.Leaf)
                        .DefineOption("id1", nameof(Int32), "test opt1", BehaviorFlags.None, "alias_id1").Add()
                        .DefineOption("id2", nameof(Int32), "test opt2", BehaviorFlags.None, "alias_id2").Add()
                        .DefineOption("id3", nameof(Boolean), "test opt3", BehaviorFlags.None).Add()
                    .Checker<MockCommandChecker>()
                    .Add()
                    .DefineCommand<MockCommandRunner>("cmd3", "cmd3", "test1", CommandTypes.Leaf)
                        .DefineOption("id1", nameof(Int32), "test opt1", BehaviorFlags.None, "alias_id1").Add()
                    .Checker<MockCommandChecker>()
                    .Add();
