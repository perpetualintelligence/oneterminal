...
namespace OneImlx.Terminal.Commands.Declarative
{
    ...
    [CommandDescriptor("id1", "name1", "description", CommandTypes.Leaf)]
    ...
    [OptionDescriptor("opt1", nameof(String), "test opt desc1", BehaviorFlags.None)]
    [OptionDescriptor("opt2", nameof(String), "test opt desc2", BehaviorFlags.Disabled, "opt2_alias")]
    [OptionValidation("opt2", typeof(RequiredAttribute))]
    [OptionValidation("opt2", typeof(OneOfAttribute), "test1", "test2", "test3")]
    [OptionDescriptor("opt3", nameof(Double), "test opt desc3", BehaviorFlags.Required | BehaviorFlags.Obsolete)]
    ...
    [ArgumentDescriptor(2, "arg2", nameof(String), "test arg desc2", BehaviorFlags.Disabled)]
    [ArgumentValidation("arg2", typeof(RequiredAttribute))]
    [ArgumentValidation("arg2", typeof(OneOfAttribute), "test1", "test2", "test3")]
    [ArgumentDescriptor(3, "arg3", nameof(Double), "test arg desc3", BehaviorFlags.Required | BehaviorFlags.Obsolete)]
