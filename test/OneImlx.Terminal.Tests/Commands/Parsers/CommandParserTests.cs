    ...
    public class CommandParserTests
    {
        public CommandParserTests()
        {
            ...
            [
                ...
                new("grp1", "grp1_name", "grp1_desc", CommandType.CompositeGroup, CommandFlags.None, new OwnerIdCollection("root1"), argumentDescriptors: arguments),
                new("grp2", "grp2_name", "grp2_desc", CommandType.CompositeGroup, CommandFlags.None, new OwnerIdCollection("root2")),
