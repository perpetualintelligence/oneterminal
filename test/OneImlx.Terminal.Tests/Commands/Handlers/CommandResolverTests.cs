...
namespace OneImlx.Terminal.Commands.Handlers
{
    public class CommandResolverTests
    {
        ...
        {
            CommandDescriptor commandDescriptor = new("test", "test_name", "test_desc", CommandType.CompositeGroup, CommandFlags.None)
            {
                Checker = null
            };
        ...
        {
            CommandDescriptor commandDescriptor = new("validChecker", "valid_name", "valid_desc", CommandType.CompositeGroup, CommandFlags.None)
            {
        ...
        {
            CommandDescriptor commandDescriptor = new("validRunner", "valid_name", "valid_desc", CommandType.CompositeGroup, CommandFlags.None)
            {
        ...
        {
            CommandDescriptor commandDescriptor = new("invalidTypeChecker", "invalid_name", "invalid_desc", CommandType.CompositeGroup, CommandFlags.None)
            {
        ...
        {
            CommandDescriptor commandDescriptor = new("invalidTypeRunner", "invalid_name", "invalid_desc", CommandType.CompositeGroup, CommandFlags.None)
            {
