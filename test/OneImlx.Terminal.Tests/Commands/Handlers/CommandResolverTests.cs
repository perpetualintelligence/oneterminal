...
namespace OneImlx.Terminal.Commands.Handlers
{
    public class CommandResolverTests
    {
        ...
        {
            CommandDescriptor commandDescriptor = new("validChecker", "valid_name", "valid_desc", CommandTypes.IsolatedGroup)
            {
        ...
        {
            CommandDescriptor commandDescriptor = new("validRunner", "valid_name", "valid_desc", CommandTypes.IsolatedGroup)
            {
        ...
        {
            CommandDescriptor commandDescriptor = new("invalidTypeChecker", "invalid_name", "invalid_desc", CommandTypes.IsolatedGroup)
            {
        ...
        {
            CommandDescriptor commandDescriptor = new("invalidTypeRunner", "invalid_name", "invalid_desc", CommandTypes.IsolatedGroup)
            {
