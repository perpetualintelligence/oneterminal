# OneImlx.Terminal.Client.Grpc

***Open. Flexible. Cross-Platform.***

> **The most flexible cross-platform framework for building modern and secured terminal apps.**

`OneImlx.Terminal.Client.Grpc` is a cross-platform library for interacting with `OneImlx.Terminal` applications and servers over gRPC.
