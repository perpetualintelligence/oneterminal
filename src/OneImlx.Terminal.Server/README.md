# OneImlx.Terminal.Server

***Open. Flexible. Cross-Platform.***

> **The most flexible cross-platform framework for building modern and secured terminal apps.**

`OneImlx.Terminal.Server` is a cross-platform library for hosting `OneImlx.Terminal` applications and servers with ASP.NET Core over TCP, UDP, and HTTP.
