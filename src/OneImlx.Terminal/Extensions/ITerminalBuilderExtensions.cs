...
namespace OneImlx.Terminal.Extensions
{
    ...
    public static class ITerminalBuilderExtensions
    {
        ...
        public static ICommandBuilder DefineCommand<TRunner>(this ITerminalBuilder builder, string id, string name, string description, int commandType) where TRunner : ICommandRunner<CommandContext, CommandRunnerResult>
        {
