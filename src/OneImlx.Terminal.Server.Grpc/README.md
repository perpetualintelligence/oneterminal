# OneImlx.Terminal.Server.Grpc

***Open. Flexible. Cross-Platform.***

> **The most flexible cross-platform framework for building modern and secured terminal apps.**

`OneImlx.Terminal.Server.Grpc` is a cross-platform library for hosting `OneImlx.Terminal` applications and servers with ASP.NET Core over gRPC.
