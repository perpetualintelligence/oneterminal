...
namespace OneImlx.Terminal.Apps.Test.Runners
{
    ...
    /// </summary>
    [CommandOwners("test")]
    [CommandDescriptor("grp1", "Group 1", "Group 1 as a composite group", CommandType.CompositeGroup, CommandFlags.None)]
    ...
    public class Grp1Runner : CommandRunner<CommandRunnerResult>, IDeclarativeRunner
    {
        ...
        [CommandDescriptor("cmd1", "Command 1", "Command 1 in grp1.", CommandType.Leaf, CommandFlags.None)]
        ...
        [CommandDescriptor("cmd2", "Command 2", "Command 2 in grp1.", CommandType.Leaf, CommandFlags.None)]
        [CommandTags("command", "leaf")]
        ...
        [CommandDescriptor("cmd3", "Command 3", "Command 3 in grp1.", CommandType.Leaf, CommandFlags.None)]
        [CommandTags("command", "leaf")]
