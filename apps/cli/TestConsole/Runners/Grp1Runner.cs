...
namespace OneImlx.Terminal.Apps.Test.Runners
{
    ...
    public class Grp1Runner : CommandRunner<CustomCommandContext, CustomRunnerResult>, IDeclarativeRunner
    {
        ...
        public async Task<CustomRunnerResult> Cmd1Async(CustomCommandContext context)
        {
        ...
        public async Task<CustomRunnerResult> Cmd2Async(CustomCommandContext context)
        {
        ...
        public async Task<CustomRunnerResult> Cmd3Async(CustomCommandContext context)
        {
