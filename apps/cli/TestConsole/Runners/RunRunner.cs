...
namespace OneImlx.Terminal.Apps.Test.Runners
{
    ...
    /// </summary>
    [CommandDescriptor("run", "Run Command", "Runs a native OS command.", ReservedCommandTypes.Native)]
    [ArgumentDescriptor(0, "cmd", nameof(String), "The full native command to execute, e.g., 'ls -all'", ReservedFlags.Required)]
